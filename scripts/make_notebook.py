    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "color1 = '#2c3e50'\n",
                "ax1.set_xlabel('Year', color='#333333')\n",
                "ax1.set_ylabel('GDP Growth (%)', color=color1)\n",
                "ax1.plot(df['Year'], df['GDP_Growth'], color=color1, linewidth=2, label='GDP Growth')\n",
                "ax1.tick_params(axis='y', labelcolor=color1)\n",
                "ax1.axhline(0, color='#999999', linewidth=1)\n",
                "\n",
                "ax2 = ax1.twinx()  # instantiate a second axes that shares the same x-axis\n",
                "color2 = '#e74c3c'\n",
                "ax2.set_ylabel('Unemployment Rate (%)', color=color2)\n",
                "ax2.plot(df['Year'], df['Unemployment_Rate'], color=color2, linewidth=2, linestyle='-', alpha=0.8, label='Unemployment')\n",
                "ax2.tick_params(axis='y', labelcolor=color2)\n",
                "ax2.spines['top'].set_visible(False)\n",
                "\n",
                "plt.title('South Africa: GDP Growth vs Unemployment', fontsize=14, pad=15)\n",
                "fig.tight_layout() \n",
                "plt.show()"
            ]
        },
        {
            ...
            "source": [
                ...
                "            scatter_kws={'s': 45, 'alpha': 0.7, 'color': '#34495e'}, \n",
                "            line_kws={'color': '#e74c3c', 'linewidth': 2})\n",
                "plt.title('Correlation: GDP Growth vs Unemployment', fontsize=14, pad=15)\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "plt.figure(figsize=(9, 5))\n",
                "sns.histplot(df['GDP_Growth'], bins=15, kde=True, color='#3498db', edgecolor='white')\n",
                "plt.title('Distribution of South African GDP Growth Rates', fontsize=14, pad=15)\n",
                "plt.xlabel('GDP Growth (%)')\n",
                "plt.ylabel('Frequency (Years)')\n",
                "plt.axvline(df['GDP_Growth'].mean(), color='#e74c3c', linestyle='--', label=f\"Mean: {df['GDP_Growth'].mean():.2f}%\")\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "plt.figure(figsize=(9, 5))\n",
                "sns.boxplot(x='Decade', y='Unemployment_Rate', data=df_box, color='#ecf0f1', fliersize=0)\n",
                "sns.swarmplot(x='Decade', y='Unemployment_Rate', data=df_box, color=\"#2c3e50\", alpha=0.6, size=6)\n",
                "plt.title('Unemployment Rate Distribution per Decade', fontsize=14, pad=15)\n",
                "plt.xlabel('Decade')\n",
                "plt.ylabel('Unemployment Rate (%)')\n",
                "sns.despine()\n",
                "plt.show()"
